...
public class MainController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        cameraFPS.transform.localPosition = new Vector3(0, 2, 0);
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Fire1"))
        {
            ...
            Vector3 postiro = new Vector3(cameraFPS.transform.position.x + 0.55f, cameraFPS.transform.position.y - 0.3f, cameraFPS.transform.position.z);
